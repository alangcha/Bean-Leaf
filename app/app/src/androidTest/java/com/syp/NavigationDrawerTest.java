...
public class NavigationDrawerTest {
    ...
    public void navigationDrawerTest() {
        ...
        ViewInteraction imageView = onView(
                allOf(withId(R.id.imageView), withContentDescription("user photo"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("Jackie Dong"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("Jackie Dong")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView), withText("Owner of Dong Cha"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.navigation_header_container),
                                        0),
                                2),
                        isDisplayed()));
        textView3.check(matches(withText("Owner of Dong Cha")));
