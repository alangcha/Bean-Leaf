...
public class DrawChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderOne.get_item_purchased().add(new Item());
        orderOne.get_item_purchased().get(0).set_name("Caffee Latte");
        orderOne.get_item_purchased().get(0).set_price(2.95);
        orderOne.get_item_purchased().add(new Item());
        orderOne.get_item_purchased().get(1).set_name("White Chocolate Mocha");
        orderOne.get_item_purchased().get(1).set_price(3.75);
        orderOne.get_item_purchased().add(new Item());
        orderOne.get_item_purchased().get(2).set_name("Pink Drink");
        orderOne.get_item_purchased().get(2).set_price(5.00);

        //Testing order Two
        Order orderTwo = new Order();
        orderTwo.get_item_purchased().add(new Item());
        orderTwo.get_item_purchased().get(0).set_name("Soy Milk Latte");
        orderTwo.get_item_purchased().get(0).set_price(3.75);
        orderTwo.get_item_purchased().add(new Item());
        orderTwo.get_item_purchased().get(1).set_name("Americano");
        orderTwo.get_item_purchased().get(1).set_price(4.35);
        orderTwo.get_item_purchased().add(new Item());
        orderTwo.get_item_purchased().get(2).set_name("Pink Drink");
        orderTwo.get_item_purchased().get(2).set_price(4.50);

        //Testing order Three
        Order orderThree = new Order();
        orderThree.get_item_purchased().add(new Item());
        orderThree.get_item_purchased().get(0).set_name("black Drink");
        orderThree.get_item_purchased().get(0).set_price(9.02);
...
//        setupPieChart(257.123);
    ...
    public void configureDailyBarChart(ArrayList<Order> userOrders)
    {
        ...
        {
            Log.d("myTag" , "this is the id in daily Order: " + Integer.toString(userTodayOrder.get(i).get_id()));
        }
    ...
    public void configureWeeklyBarChart(ArrayList<Order> userOrders)
    {
        ...
        {
            Log.d("myTag" , "this is the id in daily Order: " + Integer.toString(userThisWeekOrder.get(i).get_id()));
        }
    ...
    public void configureMonthlyBarChart(ArrayList<Order> userOrders)
    {
        ...
        {
            Log.d("myTag" , "this is the id in monthly Order: " + Integer.toString(userThisMonthOrder.get(i).get_id()));
